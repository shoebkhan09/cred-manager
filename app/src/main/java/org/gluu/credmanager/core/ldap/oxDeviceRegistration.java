...
public class oxDeviceRegistration {
    ...
    @LDAPField(attribute="creationDate",
            objectClass="oxDeviceRegistration",
            filterUsage=FilterUsage.CONDITIONALLY_ALLOWED)
    ...
    @LDAPField(attribute="oxDeviceData",
            objectClass="oxDeviceRegistration",
            filterUsage=FilterUsage.CONDITIONALLY_ALLOWED)
